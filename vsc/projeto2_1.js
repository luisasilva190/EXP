...
var ocorrencias = L.geoJSON(ocorrencias, {
...
var thecrimes= L.geoJSON (thecrimes, {
    pointToLayer: function (feature, latlng){
        ...
        if (feature.properties.Ano == "2015"){ 
            return L.circleMarker(latlng, {radius: 4, color: '#0F5298',
                                        fillOpacity:1});
            }
            ...
            return L.circleMarker(latlng, {radius: 4, color: 'yelow',
                                                    fillOpacity:1});
            }
        else{
...
var overlays = {
    ...
    'Data e Tipo de Crime': thecrimes,
    'Estado do  Crime': estado,
};
